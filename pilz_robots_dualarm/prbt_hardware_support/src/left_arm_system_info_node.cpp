...
{
  ros::init(argc, argv, "left_arm_system_info");
  ros::NodeHandle nh{"~"};

  prbt_hardware_support::LeftArmSystemInfo left_arm_system_info(nh);
  FirmwareCont versions {left_arm_system_info.getFirmwareVersions()};
