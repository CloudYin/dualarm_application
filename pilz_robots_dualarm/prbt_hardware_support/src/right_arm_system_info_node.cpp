...
{
  ros::init(argc, argv, "right_arm_system_info");
  ros::NodeHandle nh{"~"};

  prbt_hardware_support::RightArmSystemInfo right_arm_system_info(nh);
  FirmwareCont versions {right_arm_system_info.getFirmwareVersions()};
