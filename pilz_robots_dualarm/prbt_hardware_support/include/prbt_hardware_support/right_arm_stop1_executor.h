...
#ifndef RIGHT_ARM_STOP1_EXECUTOR_H
#define RIGHT_ARM_STOP1_EXECUTOR_H
...
public:
   ...
   *
   */
  RightArm_Stop1Executor(const TServiceCallFunc& hold_func,
   ...
   */
  virtual ~RightArm_Stop1Executor();
...
inline void RightArm_Stop1Executor::stopStateMachine()
{
