...
#ifndef LEFT_ARM_STOP1_EXECUTOR_H
#define LEFT_ARM_STOP1_EXECUTOR_H
...
public:
   ...
   *
   */
  LeftArm_Stop1Executor(const TServiceCallFunc& hold_func,
...
inline void LeftArm_Stop1Executor::stopStateMachine()
{
