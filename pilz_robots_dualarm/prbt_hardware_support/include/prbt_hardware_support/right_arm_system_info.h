...
#ifndef PRBT_HARDWARE_SUPPORT_RIGHT_ARM_SYSTEM_INFO_H
#define PRBT_HARDWARE_SUPPORT_RIGHT_ARM_SYSTEM_INFO_H
 ...
 * when analyzing bugs.
 */
class RightArmSystemInfo
{
public:
  RightArmSystemInfo(ros::NodeHandle& nh);
