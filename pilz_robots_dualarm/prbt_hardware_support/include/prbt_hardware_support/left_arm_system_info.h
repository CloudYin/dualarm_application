...
#ifndef PRBT_HARDWARE_SUPPORT_LEFT_ARM_SYSTEM_INFO_H
#define PRBT_HARDWARE_SUPPORT_LEFT_ARM_SYSTEM_INFO_H
 ...
 * when analyzing bugs.
 */
class LeftArmSystemInfo
{
public:
  LeftArmSystemInfo(ros::NodeHandle& nh);
